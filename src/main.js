...
const fallbackFacts = {
  ...
  DE: { capital: 'Berlin', currency: 'euro (EUR)', languages: 'niemiecki', population: 'ok. 84 mln', latlng: [51, 9] },
  FR: { capital: 'Paryż', currency: 'euro (EUR)', languages: 'francuski', population: 'ok. 68 mln', latlng: [46, 2] },
  IT: { capital: 'Rzym', currency: 'euro (EUR)', languages: 'włoski', population: 'ok. 59 mln', latlng: [42.5, 12.5] },
  ES: { capital: 'Madryt', currency: 'euro (EUR)', languages: 'hiszpański', population: 'ok. 49 mln', latlng: [40, -4] },
  ...
  IE: { capital: 'Dublin', currency: 'euro (EUR)', languages: 'irlandzki, angielski', population: 'ok. 5,3 mln', latlng: [53, -8] },
  CZ: { capital: 'Praga', currency: 'korona czeska (CZK)', languages: 'czeski', population: 'ok. 10,9 mln', latlng: [49.8, 15.5] },
  SK: { capital: 'Bratysława', currency: 'euro (EUR)', languages: 'słowacki', population: 'ok. 5,4 mln', latlng: [48.7, 19.5] },
  ...
  NL: { capital: 'Amsterdam', currency: 'euro (EUR)', languages: 'niderlandzki', population: 'ok. 18 mln', latlng: [52.2, 5.3] },
  BE: { capital: 'Bruksela', currency: 'euro (EUR)', languages: 'niderlandzki, francuski, niemiecki', population: 'ok. 11,8 mln', latlng: [50.8, 4.5] },
  ...
  UA: { capital: 'Kijów', currency: 'hrywna (UAH)', languages: 'ukraiński', population: 'ok. 37 mln', latlng: [49, 32] },
  US: { capital: 'Waszyngton', currency: 'dolar amerykański (USD)', languages: 'angielski', population: 'ok. 340 mln', latlng: [38, -97] },
  CA: { capital: 'Ottawa', currency: 'dolar kanadyjski (CAD)', languages: 'angielski, francuski', population: 'ok. 41 mln', latlng: [60, -95] },
  MX: { capital: 'Meksyk', currency: 'peso meksykańskie (MXN)', languages: 'hiszpański', population: 'ok. 130 mln', latlng: [23, -102] },
  ...
  CN: { capital: 'Pekin', currency: 'juan renminbi (CNY)', languages: 'chiński mandaryński', population: 'ok. 1,41 mld', latlng: [35, 104] },
  IN: { capital: 'Nowe Delhi', currency: 'rupia indyjska (INR)', languages: 'hindi, angielski', population: 'ok. 1,43 mld', latlng: [21, 78] },
  TH: { capital: 'Bangkok', currency: 'bat tajski (THB)', languages: 'tajski', population: 'ok. 71 mln', latlng: [15, 101] },
  ...
  EG: { capital: 'Kair', currency: 'funt egipski (EGP)', languages: 'arabski', population: 'ok. 114 mln', latlng: [27, 30] },
  ZA: { capital: 'Pretoria, Kapsztad, Bloemfontein', currency: 'rand (ZAR)', languages: '11 języków urzędowych', population: 'ok. 63 mln', latlng: [-29, 24] }
};
...
async function showCountryInfo(code) {
  ...
  const offlineFacts = fallbackFacts[code];
  if (offlineFacts) renderCountryFacts(offlineFacts);
  else {
  ...
  try {
    ...
    if (!offlineFacts) renderCountryFacts({ capital: 'Brak danych offline', currency: 'Brak danych offline', languages: 'Brak danych offline', population: 'Brak danych offline' });
  }
}
